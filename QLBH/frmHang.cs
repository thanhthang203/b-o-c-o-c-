...
namespace QLBH
{
    public partial class frmHang : Form
    {
        ...
        private void dgvHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            sql = "SELECT TenLoaiHang FROM LoaiHang WHERE MaLoaiHang=N'" + MaLoaiHang + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO Hang(MaHang,TenHang,MaLoaiHang,SoLuong,DonGiaNhap, DonGiaBan,Anh,GhiChu) VALUES(N'"
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE Hang SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaLoaiHang=N'" + cboMaLoaiHang.SelectedValue.ToString() +
        ...
        {
            string sql;
            if ((txtMaHang.Text == "") && (txtTenHang.Text == "") && (cboMaLoaiHang.Text == ""))
            {
